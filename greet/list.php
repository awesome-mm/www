  ...
  ?>
                <li class="list_item">
                  <a href="view.php?num=<?=$item_num?>&page=<?=$page?>&scale=<?=$scale?>">
                    ...
                    <div class="list_item2"><p><?= $item_subject ?></p></div>
                    <div class="list_item3"><p><?=$item_content?></p></div>
                    <div class="list_item4"><?= $item_nick ?></div>
                    <div class="list_item5"><?= $item_date ?></div>
                    <div class="list_item6"><?= $item_hit ?></div>
                  </a>
                </li>
  <?
        $number--;
