$(document).ready(function () {
  ...
  productResponData.open('GET', './Data/sub2_3.json', true);
  ...
  function productCall() {
    ...
    textProduct += '      <img class="modal_img" src="./images/sub2_3/product' + (productIndex + 1) + '.jpg" alt="">'
    textProduct += '    </div>'
...
var offset = screen.height/2 ; 
  ...
  $('#content .spy ul li a').click(function(e){
    e.preventDefault(); 
