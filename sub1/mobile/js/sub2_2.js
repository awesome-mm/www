$(document).ready(function () {
  ...
  productResponData.open('GET', './Data/sub2_2.json', true);
  ...
  function productCall() {
    ...
    textProduct += '      <img class="modal_img" src="./images/sub2_2/product' + (productIndex + 1) + '.jpg" alt="">'
    textProduct += '    </div>'
