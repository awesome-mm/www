...
window.onload = function() {
    ...
    setTimeout(function(){
        map.relayout();
        map.setCenter(new daum.maps.LatLng(37.349209, 127.187349));
        map2.relayout();
        map2.setCenter(new daum.maps.LatLng(37.278133, 127.102205));
    }, 0);


    var container = document.getElementById('officeArea');
    var options = {
        center: new daum.maps.LatLng(37.349209, 127.187349),
        level: 4
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.349209, 127.187349); 
    ...
    //두번째 맵
      ...
      var container2 = document.getElementById('yonginArea');
    var options2 = {
        center: new daum.maps.LatLng(37.278133, 127.102205),
        level: 4
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.278133, 127.102205); 
