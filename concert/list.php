<? 
	session_start(); 
	$table = "concert";
	//데이터베이스 테이블의 이름을 변수에 저장하여 사용 
	//여러 파일에서 다른 테이블을 사용할때 테이블 이름만 변경하여 사용한다
	//변수에 저장한 내용을 다른 파일로 보낼 때 get방식으로 게속하여 전달해야하는 불편함이 있다.
?>
...
?>
			<div id="list_item">
				...
				<div id="list_item2"> <img src="<?=$item_image?>" style="width:100px; height:100px;"></img></div>
